...
If we do initial filtering, we find patients that meet specific criterion, so we do not specify `id`. 
...
drug(n_ther = 2, def_tbl = antidiabetic, pat_tbl = patient, data_name = "antidiabetic_rx")
```
